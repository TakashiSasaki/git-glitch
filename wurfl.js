...
"Promise" in window &&
  ...
  "CustomEvent" in window
    ? (document.dispatchEvent(
        new CustomEvent("WurflJSInitComplete", {
          bubbles: !0,
          detail: { WURFL },
        })
      ),
      document.dispatchEvent(
        new CustomEvent("WurflJSDetectionComplete", {
          bubbles: !0,
          detail: { WURFL },
        })
      ))
    : ((newEvent = document.createEvent("CustomEvent")),
      newEvent.initCustomEvent("WurflJSInitComplete", !0, !0, { WURFL }),
      document.dispatchEvent(newEvent),
      (newEvent = document.createEvent("CustomEvent")),
      newEvent.initCustomEvent("WurflJSDetectionComplete", !0, !0, { WURFL }),
      document.dispatchEvent(newEvent))